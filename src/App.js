...
function App() {
  return (
    <div className="App">
      ...
      <div className='w-100 p-6 m-6 border-2 border-slate-500 rounded-md'>
        <h2 className='text-2xl uppercase font-bold text-blue-500'>Nouveau flux</h2>
        <form className='flex flex-col space-y-4 pt-4 lg:flex-row lg:space-x-40 lg:space-y-0 lg:items-center'>
